...
def calculations():
    ...
    # Yield assumptions per crop (lbs/tray/month)
    crop_yields = {
        'lettuce': 2.5,
        'basil': 1.8,
        'kale': 2.0,
    ...
    estimated_yield = seasonal_yield  # lbs/month
    ...
    # Store value estimates for chart
    market_price_per_lb = 4  # store average price
